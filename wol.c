...
ether_wol(p, end, src)
	...
	const char *src;
{
	static const char magic[6] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };
	static const char bad1[6] =  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
	static const char bad2[6] =  { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };
